...
input.oninput = () => {
    ...
    if (input.length <= 6) {
        easyHardPass.textContent = "Ur password to short,try again!";
    }
    else if (checker.match(/^[a-zA-Z0-9!@#$%^&*]{6,16}$/)) {
        easyHardPass.textContent = "ur password strong"
    }
    else {
        easyHardPass.textContent = "its okay,but you can better";
    }
}
